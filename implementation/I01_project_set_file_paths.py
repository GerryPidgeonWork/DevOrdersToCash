...
# ====================================================================================================
# 3. PROVIDER FOLDER STRUCTURE & REGISTRY
# ----------------------------------------------------------------------------------------------------
...
# --- 3c. Standard Internal Folder Layout ---
...
# --- 3d. Dynamic Root Path (set by GUI via initialise_provider_paths) ---
SHARED_DRIVE_ROOT: Path | None = None

# --- 3e. Master Dictionary for All Providers ---
ALL_PROVIDER_PATHS: Dict[str, Dict[str, Path]] = {}


# ====================================================================================================
# 4. PROVIDER PATH FUNCTIONS
# ----------------------------------------------------------------------------------------------------
...
def main() -> None:
    """
    Description:
        Self-test for I01_project_set_file_paths module.
    ...
    Notes:
        - Tests core path re-exports and provider path functions.
    """
    logger.info("🗂️ I01_project_set_file_paths self-test started.")
    ...
    logger.info("-" * 60)
    logger.info("✅ I01_project_set_file_paths self-test complete.")
