...
from core.C12_data_processing import standardise_columns, filter_rows, convert_to_datetime
...
__all__ = [
    "load_dwh_for_period",
    "load_je_order_detail",
    "merge_je_with_dwh",
    "find_missing_dwh_orders",
    "add_accrual_orders",
    "calculate_variances",
    "finalise_columns",
    "run_je_reconciliation",
]
...
def main() -> None:
    """
    Description:
        Self-test for JE02_data_reconciliation module.
    ...
    Notes:
        ...
        - For actual testing, call run_je_reconciliation() with appropriate parameters.
    """
    logger.info("=" * 60)
    logger.info("JE02_data_reconciliation.py - Self Test")
    logger.info("=" * 60)
    logger.info("This module should be called via G10b controller or run_je_reconciliation().")
