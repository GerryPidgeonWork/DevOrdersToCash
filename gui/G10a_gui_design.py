...
#
# GUI pages import widget factories from G02a facade only.
# ----------------------------------------------------------------------------------------------------
from core.C00_set_packages import *
...
class MainPage:
    ...
    def build_row_1(self, parent: tk.Misc) -> None:
        """Build Row 1: Overview text block and console output panel."""
    ...
    def build_row_2(self, parent: tk.Misc) -> None:
        """Build Row 2: Configuration cards (Google Drive, Snowflake, Accounting, Warehouse)."""
        ...
        col1_widget_container.pack(anchor="w", padx=(SPACING_SM, SPACING_SM), pady=(SPACING_XS, 0))
    ...
    def build_row_3(self, parent: tk.Misc) -> None:
        """Build Row 3: Marketplace workflow cards (Braintree, Uber Eats, Deliveroo, Just Eat)."""
...
def main() -> None:
    """
    Description:
        Self-test for G10a_gui_design module.
    ...
    Notes:
        - Launches the design layer without controller wiring.
        - For production use, run via G10b_gui_controller.py instead.
    """
    logger.info("=" * 60)
